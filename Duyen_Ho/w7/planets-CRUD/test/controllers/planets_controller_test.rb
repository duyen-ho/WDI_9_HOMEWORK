...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { image_url: @planet.image_url, title: @planet.title } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { image_url: @planet.image_url, title: @planet.title } }
